...
import com.qnbc.venueReservation.entity.RoleMenu;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements IRoleService {
    ...
    @Transactional
    @Override
    public void setRoleMenu(Integer roleId, RoleMenuRequest request) {
...
//        roleMenuMapper.delete(queryWrapper);
        ...
        List<Integer> menuIdsCopy = CollUtil.newArrayList(request.getMenuIds());
