<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['venueReservation:address:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['venueReservation:address:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['venueReservation:address:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['venueReservation:address:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="addressList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="openId微信用户ID" align="center" prop="userid" />
      <el-table-column label="收货地址" align="center" prop="address" />
      <el-table-column label="收货人" align="center" prop="consignee" />
      <el-table-column label="联系电话" align="center" prop="telnumber" />
...
<script>
import { listAddress, getAddress, delAddress, addAddress, updateAddress } from "@/api/venueReservation/address";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('venueReservation/address/export', {
        ...this.queryParams
