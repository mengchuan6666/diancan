<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="baseInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="名称" align="center" prop="nameKey" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="名称" prop="nameKey">
          <el-input v-model="form.nameKey" placeholder="请输入名称" />
        </el-form-item>
        <el-form-item label="开始时间" prop="startTime">
          <el-date-picker clearable
...
<script>
import { listBaseInfo, getBaseInfo, delBaseInfo, addBaseInfo, updateBaseInfo } from "@/api/springboot/baseInfo";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除基本信息配置编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('baseInfo/baseInfo/export', {
        ...this.queryParams
