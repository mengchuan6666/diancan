<template>
  <div>
    <div style="margin: 10px 0">
      ...
      名称：<el-input style="width: 200px" placeholder="请输入名称" suffix-icon="el-icon-search" v-model="username"></el-input>
       电话：<el-input style="width: 200px" placeholder="请输入电话" suffix-icon="el-icon-message" class="ml-5" v-model="phone"></el-input>
...
export default {
  ...
  methods: {
    load() {
      this.request.get("/user/page/role", {
        params: {
